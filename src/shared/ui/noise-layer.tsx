...
export const NoiseLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
...
export const CoarseNoiseLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
...
export const TurbulenceLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
...
export const MarbleLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
...
export const StaticLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
...
export const CloudLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
...
export const VignetteLayer = (props: React.HTMLProps<HTMLDivElement>) => (
  <div
    style={{
      ...base,
