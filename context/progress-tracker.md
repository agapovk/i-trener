...
- **Phase 1 — Content Entities** — не начата

---

## Текущая цель

Реализовать компоненты сущностей: MaterialCard, InterviewCard, ExpertCard; тестовый MDX-контент (2–3 файла каждого типа); валидация frontmatter.
...
### Phase 1 — Content Entities
- [ ] Валидация frontmatter (zod или ручная)
- [ ] Базовые entity-компоненты: MaterialCard, InterviewCard, ExpertCard
- [ ] Тестовый MDX-контент (по 2–3 файла каждого типа)
- [ ] Тестовый MDX-контент (по 2-3 файла каждого типа)
