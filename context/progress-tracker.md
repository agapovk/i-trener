...
- Фичи
  - пагинация в материалах, экспертах, интервью
  - сдвинуть фото в круге, чтобы лицо всегда (или оквадратить фотки)

- Страница эксперты
  - слишком тесно и кучно, тяжело разобрать экспертов. (больше отступы, меньше карточек, карточки большего размера?)
  - в бейджах фильтации добавить колисество ?! +материалы
  - mobile responsive бейджей фильтра (шрифт меньше или прокрутка) +материалы
...
### Phase 6 — Launch ✅
- [x] Pagespeed 90+ по всем метрикам
- [x] Подключение домена i-trener.ru на Vercel
- [x] Подключение vercel/analytics
- [x] Отключение старницы партнеров

### refactor/footer-ui
- [x] обновление footer layout
- [x] изменение константы соцсетей + обновил views/contacts
- [x] добавил получение пропсов в nosise-layers
